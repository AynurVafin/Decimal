...
В этом проекте предстоит реализовать библиотеку s_decimal.h на языке программирования Си. Эта библиотека должна добавить возможность работы с типом "decimal", который отсутствует в стандарте языка. 
...
- Оформления решения как статическую библиотеку (с заголовочным файлом s21_decimal.h)
- Предусмотрен Makefile для сборки библиотеки (с целями all, clean, s21_decimal.a)  